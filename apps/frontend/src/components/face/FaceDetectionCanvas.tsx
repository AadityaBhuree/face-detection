...
const FACE_CONNECTIONS: [number, number][] = [
  ...
  // Nose bridge
  [168, 6], [6, 197], [197, 195], [195, 5], [5, 4], [4, 45], [45, 44],
  // Nose tip
  [1, 2], [2, 98], [98, 97],
  // Mouth outer
  ...
  [40, 185], [185, 61],
  // Mouth inner
  [78, 191], [191, 80], [80, 81], [81, 82], [82, 13], [13, 311],
...
export function FaceDetectionCanvas({
  ...
  }, [landmarks, videoWidth, videoHeight, isFaceDetected, matchColor, drawLandmarks, drawConnections, drawBoundingBox]);
