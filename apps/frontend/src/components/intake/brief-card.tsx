  ...
  return (
    <div className={cn('w-full max-w-2xl space-y-4', className)}>
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500">
            Generated by AyuTalk AI &middot; Ready for doctor review
          </p>
        </div>
      </div>
      ...
      <div className="flex gap-3">
        <button className="flex flex-1 items-center justify-center rounded-lg bg-ayutalk-500 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-ayutalk-600 active:scale-[0.98]">
          Mark as Reviewed
        </button>
