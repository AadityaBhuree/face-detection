...
export const FACE_LANDMARK_INDICES = {
  ...
  // Nose landmarks
  NOSE_TIP: 1,
  NOSE: [1, 2, 98, 97, 5, 4, 45, 44, 195, 196, 6, 168, 19, 240, 279, 429, 436, 437, 438, 439, 448, 449, 450, 451, 452, 453],
  NOSE_BRIDGE: [6, 168, 197, 195, 5, 4, 45, 44],

  // Mouth landmarks
  MOUTH_INNER: [78, 191, 80, 81, 82, 13, 311, 310, 415, 308, 324, 318, 402, 317, 14, 87, 178, 88, 95],
  ...
  JAW: [172, 136, 150, 149, 176, 148, 152, 377, 400, 378, 379, 365, 397, 435, 367, 364, 394, 395, 369, 396, 173, 137, 177, 215, 138, 135, 210, 212, 213, 192, 203, 211, 208, 200, 421, 418, 424, 422, 432, 436, 416, 434, 430, 431, 433, 439, 427, 411, 376, 401, 435],
  ...
  IDENTITY_LANDMARKS: [
    ...
    // Nose (26 landmarks)
    1, 2, 98, 97, 5, 4, 45, 44, 195, 196,
    6, 168, 19, 240, 279, 429, 436, 437, 438, 439,
    448, 449, 450, 451, 452, 453,
    // Mouth (38 landmarks)
    61, 146, 91, 181, 84, 17, 314, 405, 321, 375,
    291, 409, 270, 269, 267, 0, 37, 39, 40, 185,
    78, 191, 80, 81, 82, 13, 311, 310, 415, 308,
    324, 318, 402, 317, 14, 87, 178, 88, 95,
    // Jaw contour (16 key points)
    172, 150, 152, 377, 365, 367, 394, 396,
    137, 215, 210, 213, 211, 200, 136, 148,
  ],
} as const;
...
export function calculateEAR(
  ...
  leftIdx: number[] = [1, 2, 3, 4, 5, 6],
  rightIdx: number[] = [],
): number {
  const pts = rightIdx.length > 0
    ? rightIdx.map((i) => eyeLandmarks[i]!)
    : eyeLandmarks;
